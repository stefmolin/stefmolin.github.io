              ...
              <div className="space-y-10">
                <AboutMeSection icon="travel" flip>
                  <p>
                    ...
                    traveled to 46 countries so far. My most recent trip was to{' '}
                    <b>Australia, Fiji, and New Zealand</b>. I speak <b>English</b> and{' '}
                    <b>Spanish</b> fluently, with some <b>survival French</b>. I would like to learn{' '}
                    <b>Italian</b>.
                  </p>
                </AboutMeSection>
